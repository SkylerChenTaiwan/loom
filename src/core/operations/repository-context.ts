      ...
      schemaShape: {
        ...
        userConfirmation: {
          ...
          confirmationBasis: {
            ...
            presentedItems: ["currentPhaseScopeSummary", "includedDeferredExcludedBoundary", "nextPhasePreview", "conceptSummary"],
          },
        },
        conceptGrounding: {
          phaseConceptGrounding: {
            ...
            concepts: [{
              ...
              explanation: "Plain explanation shown to the user.",
        ...
        frontendExperience: {
          ...
          confirmationSummary: "User confirmed the frontend delivery level for this phase.",
        },
        frontendExperienceDelta: {
          ...
          confirmationSummary: "User confirmed how this phase changes or preserves the frontend target.",
        },
        handoff: {
          ready: true,
