...
function requirementDetailTransferProjection(pgc: PlanningGenerationContract): Record<string, unknown> {
  return {
    ...
    consumeInSections: {
      ...
      frontend_experience: "Represent required input, display, feedback, navigation, target discovery/selection, action entry, refresh policy, and operation path expectations from PGC details and frontend refs.",
